...
<div className="flex flex-col gap-1"><label className="text-xs font-medium text-[#9c8a78]">Ціна, ₴</label><input type="number" value={form.price} onChange={(e) => setForm({ ...form, price: Number(e.target.value) })} required placeholder="Ціна" className="rounded-lg border border-[#e8dccb] px-3 py-2 text-[#5a4636] outline-none focus:border-[#b5552e]" /></div>
<div className="flex flex-col gap-1"><label className="text-xs font-medium text-[#9c8a78]">Знижка, %</label><input type="number" min={0} max={100} value={form.discount} onChange={(e) => setForm({ ...form, discount: Number(e.target.value) })} placeholder="Знижка %" className="rounded-lg border border-[#e8dccb] px-3 py-2 text-[#5a4636] outline-none focus:border-[#b5552e]" /></div>
